...
public class RoomStatusListModel {
    ...
    private List<RoomStatusModel> StatusList;
    ...
    public List<RoomStatusModel> getStatusList() {
        return StatusList;
    }

    public void setStatusList(List<RoomStatusModel> StatusList) {
