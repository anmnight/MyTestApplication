...
import com.example.anxiao.lesson_android.RoomStatusActivity
import com.example.anxiao.lesson_android.ScrollFlagActivity
import com.example.anxiao.lesson_fresco.FrescoActivity
...
import com.example.anxiao.lesson_java.ServiceActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        itemList.add(MainListItemBean(RoundImageActivity::class.java, "自定义图片"))
