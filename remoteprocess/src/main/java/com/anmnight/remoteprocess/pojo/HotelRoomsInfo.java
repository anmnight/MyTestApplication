...
public class HotelRoomsInfo {
    ...
    private List<RoomInfo.RoomInfoBean> listHotelRoomInfo;
    ...
    public List<RoomInfo.RoomInfoBean> getListHotelRoomInfo() {
        return listHotelRoomInfo;
    }

    public void setListHotelRoomInfo(List<RoomInfo.RoomInfoBean> listHotelRoomInfo) {
