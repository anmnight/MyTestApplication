...
public class HotelRoomsInfo {
    ...
    private List<RoomTypeInfo.RoomInfoBean> listHotelRoomInfo;
    ...
    public List<RoomTypeInfo.RoomInfoBean> getListHotelRoomInfo() {
        return listHotelRoomInfo;
    }

    public void setListHotelRoomInfo(List<RoomTypeInfo.RoomInfoBean> listHotelRoomInfo) {
