...
import com.anmnight.localserver.pojo.CardInfoHttpResponse;
...
public class CardInfoApi {
    ...
    private CardFaceDao mCardFaceDao = LocalServerApplication.getInstance().database.cardFaceDao();
    private CardInfoDao mCardInfoDao = LocalServerApplication.getInstance().database.cardInfoDao();
